  ...
  const menuSections = [
    {
      title: '会员服务',
      items: [
        { icon: Crown,    label: '专属订阅管理', value: '高级版',  onClick: () => navigate('/recharge', { state: { from: 'profile' } }) },
    ...
    <div className="flex-1 overflow-y-auto pb-8 no-scrollbar relative z-10">
      ...
      <div className="px-4 mt-8 mb-8">
        <div className="bg-[#160D1A] border border-[#FF2A6D]/20 rounded-2xl p-6 text-center relative overflow-hidden shadow-[0_10px_30px_rgba(168,124,255,0.15)]">
          ...
          <h3 className="text-[#F9EDF5] text-lg font-bold mb-1 relative z-10">会员尊享服务</h3>
          <p className="text-xs text-[#9B859D] mb-2 relative z-10">解锁更细腻的互动反馈、专属剧情与优先响应</p>
          <p className="text-[11px] text-[#FF7DAF] mb-5 relative z-10">今晚，也可以和她更近一点</p>
          <button
